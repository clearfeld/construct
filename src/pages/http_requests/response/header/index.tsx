...
export default function Headers() {
	...
	const get_response_headers = useRequestStore(
		(state: RequestSlice) => state.response_headers,
	);
		...
		<div {...stylex.props(styles.wrapper)}>
			...
			<div>
				<div {...stylex.props(styles.headerRow)}>
					...
					<div
						{...stylex.props(styles.cell, styles.flexGrow, styles.borderRight)}
					>
				...
				{get_response_headers?.map((header_line: any) => {
					...
					return <TableRow key={header.key} header={header} />;
				})}
			</div>
		</div>
	);
